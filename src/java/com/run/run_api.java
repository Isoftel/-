...
public class run_api extends HttpServlet implements Runnable {
    ...
    public void worning() {
        DateFormat dateFormat_set_start = new SimpleDateFormat("yyyy-MM-dd 15:30:10");
        DateFormat dateFormat_set_end = new SimpleDateFormat("yyyy-MM-dd 15:31:35");
        try {
